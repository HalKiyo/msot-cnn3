...
def load(inkey, outkey, model_type='continuous'):
    infile = f"/docker/mnt/d/research/D2/cnn3/predictors/{inkey}.npy"
    outfile = f"/docker/mnt/d/research/D2/cnn3/predictant/{model_type}/{outkey}.npy"
...
def shuffle(indata, outdata, vsample, seed=1, lat_grid=14, lon_grid=18):
