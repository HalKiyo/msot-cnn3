...
def main():
    ...
    EVAL.lineplot_reliability(pred_class, 
                              pred_continuous,
                              y_val_class,
                              y_val_continuous,
                              continuous_threshold=0.3,
...
#############################################################################
    ...
    def lineplot_reliability(self,
        ...
        y_val_class: (1000, 400)
        y_val_continuous: (1000, 400)
        pixel = 190 # chaophraya river
        """
        # reliability and nrmse calculation
        grid_id = 190
        test_length = 25
        individual_pred = pred_continuous[grid_id, :test_length]
        individual_val = y_val_continuous[:test_length, grid_id]
        individual_prob = pred_class[grid_id, :test_length, :]
        ...
        lineplot(individual_pred, individual_val, individual_prob, reliability_lst)
