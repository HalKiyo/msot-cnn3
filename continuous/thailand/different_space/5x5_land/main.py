...
class Pixel():
    def __init__(self):
        ...
        self.savefile = f"/docker/mnt/d/research/D2/cnn3/train_val/continuous/diff_space/5x5_land/{self.tors}-{self.tant}.pickle"
        self.weights_dir = f"/docker/mnt/d/research/D2/cnn3/weights/continuous/diff_space/5x5_land/{self.tors}-{self.tant}"
        self.pred_dir = f"/docker/mnt/d/research/D2/cnn3/result/continuous/thailand/{self.resolution}/diff_space/5x5_land"
