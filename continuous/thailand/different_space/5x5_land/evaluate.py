...
class evaluate():
    def __init__(self):
        ...
        self.train_val_path = self.workdir + f"/train_val/continuous/diff_space/5x5_land/{self.tors}-{self.tant}.pickle"
        self.weights_dir = self.workdir + f"/weights/continuous/diff_space/5x5_land/{self.tors}-{self.tant}"
        self.result_dir = self.workdir + f"/result/continuous/thailand/{self.resolution}/diff_space/5x5_land/{self.tors}-{self.tant}"
